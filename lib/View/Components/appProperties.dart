...
const Color lightBlue = Color.fromARGB(255, 225, 247, 255);
...
const Color darkGrey = Color.fromARGB(255, 121, 121, 121);
const Color softGrey = Color.fromARGB(249, 178, 178, 178);
